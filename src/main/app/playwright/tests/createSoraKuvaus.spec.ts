...
test.describe('Create SORA-kuvaus', () => {
  ...
  // korjata - ja juuri se kanava on kirjastojen välillä eri, joten testi
  // kirjoitetaan ennen vaihtoa.
  //
  ...
  // Field.tsx:n submitError-wrapper on kaikkien lomakkeiden kenttien tiellä, ja jos
  // sen memoisointi hajoaa, react-final-form näkee joka renderillä uuden
  // component-propin ja mounttaa kentän uudelleen: kenttään jää "N", kun pitäisi
  // jäädä "Nimi merkki kerrallaan".
