...
export const fillKuvausAndOsaamistavoitteetSection = (
  page: Page,
...
test.describe('Create toteutus', () => {
  ...
  // FieldArrayn, joten tämä vartioi Field.tsx:n wrapperin memoisointia juuri tällä
  // lomakkeella.
  ...
  // muotoon {} (isEmptyTranslatedField). Sama kuin Haulla.
