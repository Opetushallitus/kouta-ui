...
test.describe('Edit oppilaitoksen osa', () => {
  ...
  // UrlInput lisää puuttuvan http://-etuliitteen blurissa. redux-formin BLUR-reducer
  // kirjoitti tapahtuman arvon kentän arvoksi, react-final-formin onBlur ei lue arvoa
  // lainkaan, joten UrlInput antaa muutoksen onChangella ennen onBluria.
  //
  // Osoite kirjoitetaan ILMAN protokollaa: fixturen wwwSivu on jo http://-alkuinen ja
  // menee läpi koskemattomana, joten pelkkä runkosnapshot olisi sama kumminkin.
  ...
  // Tyhjennetty käännetty kenttä. Kampus kelpaa, koska sitä ei validoida lainkaan.
  // Oppilaitoksen osan footer EI rakenna runkoa kenttärekisterin avulla, joten tyhjä
  // merkkijono säilyy - toisin kuin Haulla, Toteutuksella, Koulutuksella ja
