...
// Organisaation valinta ja suosikit etusivulla. Käyttäjä on OPH-pääkäyttäjä
// (stubCommonRoutes), joten organisaatiopuu näytetään vasta vähintään kolmen merkin
// haulla, ja Opetushallitus on oletusvalinta.
