...
export const development = ({ isCypress }) => ({
  ...
  'kouta-backend.sora-kuvaus': `${koutaBackendDevUrl}/sora-kuvaus`,
  'kouta-backend.sora-kuvaus-by-id': `${koutaBackendDevUrl}/sora-kuvaus/$1`,
  'kouta-backend.sora-kuvaus-list': `${koutaBackendDevUrl}/sora-kuvaus/list`,
