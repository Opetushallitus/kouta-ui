...
export const development = ({ isCypress }) => ({
  ...
  'kouta-backend.search.koulutukset': `${koutaBackendDevUrl}/search/koulutus`,
  'kouta-backend.search.toteutukset': `${koutaBackendDevUrl}/search/toteutus`,
  'kouta-backend.search.haut': `${koutaBackendDevUrl}/search/haku`,
  'kouta-backend.search.hakukohteet': `${koutaBackendDevUrl}/search/hakukohde`,
  'kouta-backend.search.valintaperusteet': `${koutaBackendDevUrl}/search/valintaperuste`,
