const production = {
  ...
  'kouta-backend.asiasana-search': '/kouta-backend/asiasana/search/$1?kieli=$2&limit=$3',
  'kouta-backend.ammattinimike-search': '/kouta-backend/ammattinimike/search/$1?kieli=$2&limit=$3',
  ...
  'eperusteet-service.perusteet-koulutuskoodilla' : '/eperusteet-service/api/perusteet?tuleva=true&siirtyma=false&voimassaolo=true&poistunut=false&kieli=fi&koulutuskoodi=$1',
  'eperusteet-service.osaamisalakuvaukset' : '/eperusteet-service/api/perusteet/$1/osaamisalakuvaukset',
  'organisaatio-service.base-url' : '/',
  'organisaatio-service.children' : '/organisaatio-service/rest/organisaatio/v4/$1/children?includeImage=false'
};
...
const development = {
  ...
  'kouta-backend.asiasana-search': 'http://localhost:' + process.env.REACT_APP_BACKEND_PORT + '/kouta-backend/asiasana/search/$1?kieli=$2&limit=$3',
  'kouta-backend.ammattinimike-search': 'http://localhost:' + process.env.REACT_APP_BACKEND_PORT + '/kouta-backend/ammattinimike/search/$1?kieli=$2&limit=$3',
