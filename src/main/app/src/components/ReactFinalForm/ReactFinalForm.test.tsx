 ...
 * kenttien mountatessa. Jos useForm ottaisi joukosta tilannekuvan renderin aikana,
 ...
 * paikkaamaton olio ilman getiä.
 *
 * FieldArrayList välittää sen eteenpäin muodossa
 * children({ field, index, fields }), ja kutsupaikan tyyppi on
 * FieldArrayFieldsProps - joten fields.get(0) läpäisee tyyppitarkistuksen ja
