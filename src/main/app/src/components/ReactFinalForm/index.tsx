...
// Tallenna kutsuu form.submit():a. Footerista suoraan kutsuttuna kirjasto ei tietäisi
// tallennuksesta mitään - submitting ja submitErrors jäisivät tyhjiksi ja molemmat
// olisi pidettävä omassa contextissa. Näin ne, kenttien meta.submitError ja
// tuplaklikkaussuoja saadaan kirjastolta ilman omaa tilaa.
