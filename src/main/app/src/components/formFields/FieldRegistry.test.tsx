...
describe('FieldRegistry', () => {
  ...
  // jätti nimen kumpaankin joukkoon. Yhden laskurin myötä sellaista tilaa ei ole:
  // kun toinen kopio unmounttautuu, laskuri on yhä 1.
  ...
  // Uudelleenalustuksen järjestys: tyhjennys tulee eleestä, eli eri commitista kuin
  // se render, jossa uudet arvot saapuvat ja niiden piilottamat kentät unmounttaavat.
  // Efektissä ajettuna tyhjennys söisi samaan alustukseen kuuluvan piilotuksen.
