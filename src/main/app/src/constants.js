...
export const OPETUSHALLITUS_APP_TARJONTA_CRUD_ROOLI = `APP_TARJONTA_CRUD_${OPETUSHALLITUS_ORGANISAATIO_OID}`;

export const KOUTA_INDEX_READ_ROLE = 'APP_TARJONTA_CRUD';
