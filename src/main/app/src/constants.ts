...
export const TOHTORITUTKINTOTYYPPI = 'tutkintotyyppi_16';
...
export const KOULUTUSTYYPIT_WITH_MULTIPLE_MAKSULLISUUSTYYPPI: Array<Koulutustyyppi> =
  [
    KOULUTUSTYYPPI.AMMATILLINEN_KOULUTUS,
    KOULUTUSTYYPPI.LUKIOKOULUTUS,
    KOULUTUSTYYPPI.TUTKINNON_OSA,
