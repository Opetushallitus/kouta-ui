...
// Vain initialValues tilataan. Arvoja ei lueta täältä: tallennus saa ne kirjaston
// onSubmitista, ja values-tilaus renderöisi jokaisen footerin joka näppäinpainalluksella.
...
export const useForm = (): FormStateWithCorrectTypes => {
  ...
  const form = useMemo(
    () => ({
      ...
      // FieldRegistryProvider renderöi uudelleen kenttien mountatessa, joten renderin
      // aikana luettu arvo olisi helposti tyhjä tai vanhentunut. Getterinä se
      // evaluoituu vasta lukuhetkellä, joka on tallennushetki.
      //
...
// lopetus tulevat kirjastolta, joten elinkaaresta jää omaksi vain tämä.
...
// mutta kutsupaikat käyttävät yksinomaan changea - ja juuri kapea rajapinta teki
// kirjastonvaihdosta mahdollisen.
