...
// asettaa sen ReactFinalFormin refiin, josta <Form> kutsuu sitä. Siksi submitting-tilaa
// ei aseteta itse, ja virheet PALAUTETAAN eikä kirjata contextiin - kirjasto vie ne
// submitErrorsiin ja kenttien meta.submitErroriin.
