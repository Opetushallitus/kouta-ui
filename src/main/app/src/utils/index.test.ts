...
describe('getValuesForSaving', () => {
  test.each([
    ...
    {
      // Huom: nollaus tapahtuu vain koska yhtäkään kieltä ei ole rekisteröitynä.
      // Käytännössä kieliversion poisto EI nollaa kenttää, koska FormCollapse
      // vaihtaa tilalle languages[0]:n ja sisarkieli pysyy rekisteröitynä.
...
// getFieldNameWithoutLanguage tekee rekisteröinnistä KENTTÄ- eikä kielikohtaisen,
// joten getValuesForSaving riippuu suoraan näistä reunatapauksista.
test.each([
  ['nimi.fi', 'nimi'],
  ['nimi.sv', 'nimi'],
  ['nimi.en', 'nimi'],
