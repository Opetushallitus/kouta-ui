...
export const getValuesForSaving = (
  ...
  // TranslatedField, eli kielistys on yksitasoista - sisäkkäinen kielistys kääntäisi järjestyksen typistyksen
  // jälkeen. Kääntäjä ei valvo (2):ta (TranslatedField<any>), joten se nojaa tarkastukseen. Jos kumpi tahansa
  // invariantti murtuu, typistys on siirrettävä ennen lajittelua. Rekisteröityjen silmukka alempana lajitellaan
  // tarkoituksella päinvastoin (nousevasti), koska siinä vanhempi pitää kirjoittaa ennen lapsia.
