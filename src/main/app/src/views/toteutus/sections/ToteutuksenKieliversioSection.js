...
export class ToteutuksenKieliversioSection extends AbstractCheckboxSection {
  ...
  getOptionsStateName = () => APP_STATE_KOULUTUKSEN_KIELIVERSIO_OPTIONS;

  getSelectionsStateName = () => APP_STATE_KOULUTUKSEN_KIELIVERSIO_SELECTIONS;

  getSelectionChangeEventName = () => APP_EVENT_KOULUTUKSEN_KIELIVERSIO_SELECTION_CHANGE;

  getSelectionClearEventName = () => APP_EVENT_KOULUTUKSEN_KIELIVERSIO_SELECTION_CLEAR;

  getHeader = () => 'Kieliversiot';

  getClassName = () => 'ToteutuksenKieliversioSection';

  getCssClassName = () => 'checkbox-section toteutuksen-kieliversio-section';
