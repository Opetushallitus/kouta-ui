...
public class UrlConfiguration extends OphProperties {
    ...
    public UrlConfiguration(Environment environment) {
        ...
        this.frontProperties.setProperty("kouta-backend.toteutus-opintojaksot", this.require("kouta-backend.toteutus-opintojaksot"));
        ...
        this.frontProperties.setProperty("kouta-backend.hakukohteet-tilamuutos", this.require("kouta-backend.hakukohteet-tilamuutos"));
        ...
        this.frontProperties.setProperty("kouta-backend.oppilaitos-organisaatiot-for-avoin-korkeakoulutus", this.require("kouta-backend.oppilaitos-organisaatiot-for-avoin-korkeakoulutus"));
        ...
        this.frontProperties.setProperty("kayttooikeus-service.omattiedot", this.require("kayttooikeus-service.omattiedot"));
